...
install_server_automatic() {
    ...
    TCP_NODELAY="true"; TCP_KEEPALIVE=3; TCP_READBUFFER=32768; TCP_WRITEBUFFER=32768
    MAX_CONNECTIONS=300
    OBFS_ENABLED="true"; OBFS_MIN_PAD=4; OBFS_MAX_PAD=32; OBFS_MIN_DELAY=0; OBFS_MAX_DELAY=0
